...
class IdData: ObservableObject {
    @Published var idStore: [IdStore] = [
        ...
        IdStore(id: UUID(), name: "정한두", profileImgString: "Doo", userID: "jeonghandoo", numberOfPosts: 2, numberOfFollowrs: 3, numberOfFollowing: 3203, numberOfComments: 79, profileMessage: "안녕하세요 정한두입니다.", isFollow: false),
