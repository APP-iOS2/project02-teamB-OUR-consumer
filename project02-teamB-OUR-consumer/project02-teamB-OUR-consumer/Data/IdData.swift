...
class IdData: ObservableObject {
    var idStore: [IdStore] = [
        ...
        IdStore(id: UUID(), name: "김튜나", profileImgString: "Tuna", userID: "kimtuna", numberOfPosts: 21, numberOfFollowrs: 3, numberOfFollowing: 99, numberOfComments: 34, profileMessage: "참치는 맛있옹")
    ]
